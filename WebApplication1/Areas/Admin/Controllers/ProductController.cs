...
public class ProductController : Controller
{
    ...
    {
        var a = ModelState.Where(u => u.Value.Errors.Any()).Select(u => new { u.Key, u.Value });
    ...
    {
        var productList = _unitOfWork.Product.GetAll(includeProperties:$"{nameof(Category)},CoverType");
