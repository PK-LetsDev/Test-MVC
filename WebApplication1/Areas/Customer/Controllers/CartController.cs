...
public class CartController : Controller
{
	...
	public CartController(IUnitOfWork unitOgWork)
	{
	...
	public IActionResult Summary()
	{
		...
		ShoppingCartVM.OrderHeader.ApplicationUser =
			_unitOfWork.ApplicationUser.GetFistOrDefault(u => u.Id == claim.Value);
	...
	public IActionResult SummaryPOST()
	{
		...
		ApplicationUser applicationUser = _unitOfWork.ApplicationUser.GetFistOrDefault(u => u.Id == claim.Value);
	...
	{
		OrderHeader orderHeader = _unitOfWork.OrderHeader.GetFistOrDefault(u => u.Id == id);
